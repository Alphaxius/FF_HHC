...
6.  Load bluetoothTest and run. Open the RemoteXY app on your phone. Both the
    free and paid versions work as of writing this (16 March 2020). If you have
    not yet connected to the device, press the + in the top right corner of the
    app. Select Bluetooth BLE. You should see the device name "RemoteXY".
    Select that device and it should begin connecting. You should then see 
    random values on your phone screen. If you do not observe this, consult
    the repair manual (Secion XXX).
...
11. Connect the battery monitor (through the compatibility circuit) to the
    sensor board. Use a variable power supply from 10 to 15 volts, or connect a
    12 volt battery. Load batteryTest and run. Open the serial monitor, you
    should see the battery voltage approximately represented. If you do not
    observe this, consult the repair manual (Section XXX).
